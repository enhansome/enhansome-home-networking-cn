...
* OpenWrt 第三方修改版
  ...
  * [OpenWrt Lean 修改版](https://github.com/coolsnowwolf/lede) ⭐ 31,586 | 🐛 870 | 🌐 C | 📅 2026-08-27<br>代码开源。在添加适合中国用户的特色功能的基础上，尽量保持精简。
...
* 同时支持 NAT 打洞和服务器中转的内网穿透工具
  * [frp](https://github.com/fatedier/frp) ⭐ 109,062 | 🐛 53 | 🌐 Go | 📅 2026-08-27: 支持多种协议的内网穿透工具
