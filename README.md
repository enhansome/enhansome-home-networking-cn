# Awesome Home Networking with stars
...
* [blanboom/awesome-technical-diy-cn: DIY Projects/Tools/Books for Makers](https://github.com/blanboom/awesome-technical-diy-cn) ⭐ 141 | 🐛 2 | 📅 2024-01-29
* [blanboom/tiny-projects: 计算机科学领域的入门 DIY 项目，例如自制操作系统、CPU、编译器等](https://github.com/blanboom/tiny-projects) ⭐ 10 | 🐛 0 | 📅 2024-08-15
...
Created by [gh-md-toc](https://github.com/ekalinin/github-markdown-toc.go) ⭐ 524 | 🐛 3 | 🌐 Go | 📅 2026-08-20
...
* OpenWrt 第三方修改版
  ...
  * [OpenWrt Lean 修改版](https://github.com/coolsnowwolf/lede) ⭐ 31,584 | 🐛 869 | 🌐 C | 📅 2026-08-23<br>代码开源。在添加适合中国用户的特色功能的基础上，尽量保持精简。
...
另外 fq\_codel 和 CAKE 等算法在家用路由器上也逐渐得到了应用，可以做到无需复杂的配置，智能的管理流量。这项功能在 OpenWrt 中被称为 SQM，在其他路由器固件中的「智能 QoS」、「智能队列」等选项，一般也是指的这项功能。
...
* 同时支持 NAT 打洞和服务器中转的内网穿透工具
  * [frp](https://github.com/fatedier/frp) ⭐ 109,019 | 🐛 56 | 🌐 Go | 📅 2026-08-17: 支持多种协议的内网穿透工具
  * [nps](https://github.com/ehang-io/nps) ⭐ 34,175 | 🐛 525 | 🌐 Go | 📅 2024-05-30: 支持多种协议的内网穿透工具
...
* [迅雷快鸟 Xunlei Network Accelerator For Router](https://github.com/fffonion/Xunlei-Fastdick) ⭐ 814 | 🐛 26 | 🌐 Python | 📅 2020-09-27
...
* Entware/Optware<br>不少路由器操作系统，例如 Asuswrt-Merlin、DD-WRT、Synology Router Manager 等，默认不支持安装第三方软件，或者对第三方软件的支持有限，可通过 Entware/Optware 的方式来安装软件。
  ...
  * [Entware/Entware: Ultimate repo for embedded devices](https://github.com/Entware/Entware) ⭐ 2,772 | 🐛 69 | 🌐 C | 📅 2026-08-13
...
* [drcoms/drcom-generic: Dr.COM/DrCOM 现已覆盖 d p x三版。](https://github.com/drcoms/drcom-generic) ⭐ 1,193 | 🐛 47 | 🌐 Python | 📅 2023-03-08：Dr.COM 认证
...
* [geerlingguy/internet-monitoring](https://github.com/geerlingguy/internet-monitoring) ⚠️ Archived 使用 Docker 和 Prometheus 监控家庭网络
* [nali](https://github.com/meteoral/Nali) ⭐ 31 | 🐛 1 | 🌐 C | 📅 2015-08-05 为 `ping`, `traceroute`, `nslookup` 等命令增加中文地理位置信息
...
* IPTV 单线复用
  * [网络设备 篇一：家庭网络改造-单线复用实践总结\_值客原创\_什么值得买](https://post.smzdm.com/p/alpzdxpo/)
...
欢迎通过[提交 Issue](https://github.com/blanboom/awesome-home-networking-cn/issues/new) ⭐ 1,862 | 🐛 2 | 📅 2025-10-28，或[提交 Pull request](https://github.com/blanboom/awesome-home-networking-cn/pulls) ⭐ 1,862 | 🐛 2 | 📅 2025-10-28 的方式，为本文档做出贡献。
